...
#define _InGame 0xD1138D
#define _CurrentTargetGUID 0xC6BC08
#define _MouseOverGUID 0xC6BBF0  
#define _PetGUID 0x00B43B60 

#define ClickToMove  0x493760
#define CGUnit_OnRightClick 0x1D1DF0 
#define FrameScript__Execute 0x75350
#define FrameScript_GetText  0x764D0
#define ClntObjMgrGetActivePlayerObj 0x34D0
#define ClntObjMgrGetActivePlayer 0x3FBB20
#define CGGameUI__Target 0x578830


enum ObjectManager
{
	CurMgrPointer = 0xDC9598,
	CurMgrOffset = 0x462C,
	NextObject = 0x3c,
	FirstObject = 0xCC,
	LocalGUID = 0xD0
...
enum CastingInfo
{
	CastingInfo_IsCasting = 0xA34,
	CastingInfo_ChanneledCasting = 0xA48,
	CastingInfo_CastEndTime = 0xA44,
	CastingInfo_GetTime = 0xAC7498,   //FrameTime__GetCurTimeMs;
};
...
{
	CgUnitCGetCreatureType_Offset1 = 0x91C,
	CgUnitCGetCreatureType_Offset2 = 0x14
};
...
/// </summary>
 enum IsFlying
{
	IsFlying_Pointer = 0x100,
	IsFlying_Offset = 0x38,
	IsFlying_Mask = 0x1000000
};
 enum IsFalling
 {
	 IsFalling_Pointer = 0x100,    //4.3.2
	 IsFalling_Offset = 0x38,      //4.3.2
	 IsFalling_Mask = 0x800  //4.3.2
 };

 enum UnitSpeed
 {
	 UnitSpeed_Pointer1 = 0x100,
		UnitSpeed_Pointer2 = 0x80
 };
